...
def register_txt2img_tool(mcp):
    ...
    async def txt2img(
        ...
        """
        try:
            return await comfyui_txt2img_impl(prompt, pic_width, pic_height, negative_prompt, batch_size, model)
            ...
            raise Exception(f"文生图服务异常: {str(e)} | text-to-image service error: {str(e)}") 